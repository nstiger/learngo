...
func main() {
	//Create a flat representition of our matrix
	...
	fmt.Println("-----Modify a single element.-----")
	fa1 := mat.Formatted(a, mat.Prefix("      "))
	fmt.Printf("mat = %v\n\n", fa1)


	//Modify an entire row.
	a.SetRow(0, []float64{14.3, -4.2})
	fmt.Println("-----Modify an entire row.-----")
	fa2 := mat.Formatted(a, mat.Prefix("      "))
	fmt.Printf("mat = %v\n\n", fa2)

	//Modify an entire column
	a.SetCol(0, []float64{1.7, -0.3})
	fmt.Println("-----Modify an entire column-----")
	fa3 := mat.Formatted(a, mat.Prefix("      "))
	fmt.Printf("mat = %v\n\n", fa3)
